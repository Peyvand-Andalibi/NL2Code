...
class LSTM(Layer):
    ...
    def __call__(self, X, mask=None, init_state=None, dropout=0, train=True, srng=None):
        ...
        self.W = T.concatenate([self.W_z, self.W_r, self.W_h],axis=1)
        self.U = T.concatenate([self.U_z, self.U_r, self.U_h], axis=1)
        self.b = T.concatenate([self.b_z, self.b_r, self.b_h])
