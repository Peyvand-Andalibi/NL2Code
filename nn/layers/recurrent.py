...
class LSTM(Layer):
    def __init__(self, input_dim, output_dim,
        ...
        self.W_z_0 = theano.shared(self.initializer_1(shape=(self.input_dim, self.output_dim)).eval())
        self.U_z_0 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_z_0 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_r_0 = theano.shared(self.initializer_1(shape=(self.input_dim, self.output_dim)).eval())
        self.U_r_0 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_r_0 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_h_0 = theano.shared(self.initializer_1(shape=(self.input_dim, self.output_dim)).eval())
        self.U_h_0 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_h_0 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_z_1 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_z_1 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_z_1 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_r_1 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_r_1 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_r_1 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_h_1 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_h_1 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_h_1 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_z_2 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_z_2 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_z_2 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_r_2 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_r_2 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_r_2 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_h_2 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_h_2 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_h_2 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_z_3 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_z_3 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_z_3 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_r_3 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_r_3 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_r_3 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_h_3 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_h_3 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_h_3 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_z_4 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_z_4 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_z_4 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_r_4 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_r_4 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_r_4 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_h_4 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_h_4 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_h_4 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_z_5 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_z_5 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_z_5 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_r_5 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_r_5 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_r_5 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_h_5 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_h_5 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_h_5 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_z_6 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_z_6 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_z_6 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_r_6 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_r_6 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_r_6 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_h_6 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_h_6 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_h_6 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_z_7 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_z_7 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_z_7 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_r_7 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_r_7 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_r_7 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_h_7 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_h_7 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_h_7 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_z_8 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_z_8 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_z_8 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_r_8 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_r_8 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_r_8 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_h_8 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_h_8 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_h_8 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_z_9 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_z_9 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_z_9 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_r_9 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_r_9 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_r_9 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())

        self.W_h_9 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.U_h_9 = theano.shared(self.initializer_1(shape=(self.output_dim, self.output_dim)).eval())
        self.b_h_9 = theano.shared(self.initializer_2(shape=(self.output_dim)).eval())
