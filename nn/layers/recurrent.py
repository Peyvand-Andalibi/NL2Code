...
class LSTM(Layer):
    def __init__(self, input_dim, output_dim,
        ...
        self.W_z_0 = self.init((self.input_dim, self.output_dim))
        self.U_z_0 = self.inner_init((self.output_dim, self.output_dim))
        self.b_z_0 = shared_zeros((self.output_dim))

        self.W_r_0 = self.init((self.input_dim, self.output_dim))
        self.U_r_0 = self.inner_init((self.output_dim, self.output_dim))
        self.b_r_0 = shared_zeros((self.output_dim))

        self.W_h_0 = self.init((self.input_dim, self.output_dim))
        self.U_h_0 = self.inner_init((self.output_dim, self.output_dim))
        self.b_h_0 = shared_zeros((self.output_dim))

        self.W_z_1 = self.init((self.output_dim, self.output_dim))
        self.U_z_1 = self.inner_init((self.output_dim, self.output_dim))
        self.b_z_1 = shared_zeros((self.output_dim))

        self.W_r_1 = self.init((self.output_dim, self.output_dim))
        self.U_r_1 = self.inner_init((self.output_dim, self.output_dim))
        self.b_r_1 = shared_zeros((self.output_dim))

        self.W_h_1 = self.init((self.output_dim, self.output_dim))
        self.U_h_1 = self.inner_init((self.output_dim, self.output_dim))
        self.b_h_1 = shared_zeros((self.output_dim))

        self.W_z_2 = self.init((self.output_dim, self.output_dim))
        self.U_z_2 = self.inner_init((self.output_dim, self.output_dim))
        self.b_z_2 = shared_zeros((self.output_dim))

        self.W_r_2 = self.init((self.output_dim, self.output_dim))
        self.U_r_2 = self.inner_init((self.output_dim, self.output_dim))
        self.b_r_2 = shared_zeros((self.output_dim))

        self.W_h_2 = self.init((self.output_dim, self.output_dim))
        self.U_h_2 = self.inner_init((self.output_dim, self.output_dim))
        self.b_h_2 = shared_zeros((self.output_dim))

        self.W_z_3 = self.init((self.output_dim, self.output_dim))
        self.U_z_3 = self.inner_init((self.output_dim, self.output_dim))
        self.b_z_3 = shared_zeros((self.output_dim))

        self.W_r_3 = self.init((self.output_dim, self.output_dim))
        self.U_r_3 = self.inner_init((self.output_dim, self.output_dim))
        self.b_r_3 = shared_zeros((self.output_dim))

        self.W_h_3 = self.init((self.output_dim, self.output_dim))
        self.U_h_3 = self.inner_init((self.output_dim, self.output_dim))
        self.b_h_3 = shared_zeros((self.output_dim))

        self.W_z_4 = self.init((self.output_dim, self.output_dim))
        self.U_z_4 = self.inner_init((self.output_dim, self.output_dim))
        self.b_z_4 = shared_zeros((self.output_dim))

        self.W_r_4 = self.init((self.output_dim, self.output_dim))
        self.U_r_4 = self.inner_init((self.output_dim, self.output_dim))
        self.b_r_4 = shared_zeros((self.output_dim))

        self.W_h_4 = self.init((self.output_dim, self.output_dim))
        self.U_h_4 = self.inner_init((self.output_dim, self.output_dim))
        self.b_h_4 = shared_zeros((self.output_dim))

        self.W_z_5 = self.init((self.output_dim, self.output_dim))
        self.U_z_5 = self.inner_init((self.output_dim, self.output_dim))
        self.b_z_5 = shared_zeros((self.output_dim))

        self.W_r_5 = self.init((self.output_dim, self.output_dim))
        self.U_r_5 = self.inner_init((self.output_dim, self.output_dim))
        self.b_r_5 = shared_zeros((self.output_dim))

        self.W_h_5 = self.init((self.output_dim, self.output_dim))
        self.U_h_5 = self.inner_init((self.output_dim, self.output_dim))
        self.b_h_5 = shared_zeros((self.output_dim))

        self.W_z_6 = self.init((self.output_dim, self.output_dim))
        self.U_z_6 = self.inner_init((self.output_dim, self.output_dim))
        self.b_z_6 = shared_zeros((self.output_dim))

        self.W_r_6 = self.init((self.output_dim, self.output_dim))
        self.U_r_6 = self.inner_init((self.output_dim, self.output_dim))
        self.b_r_6 = shared_zeros((self.output_dim))

        self.W_h_6 = self.init((self.output_dim, self.output_dim))
        self.U_h_6 = self.inner_init((self.output_dim, self.output_dim))
        self.b_h_6 = shared_zeros((self.output_dim))

        self.W_z_7 = self.init((self.output_dim, self.output_dim))
        self.U_z_7 = self.inner_init((self.output_dim, self.output_dim))
        self.b_z_7 = shared_zeros((self.output_dim))

        self.W_r_7 = self.init((self.output_dim, self.output_dim))
        self.U_r_7 = self.inner_init((self.output_dim, self.output_dim))
        self.b_r_7 = shared_zeros((self.output_dim))

        self.W_h_7 = self.init((self.output_dim, self.output_dim))
        self.U_h_7 = self.inner_init((self.output_dim, self.output_dim))
        self.b_h_7 = shared_zeros((self.output_dim))

        self.W_z_8 = self.init((self.output_dim, self.output_dim))
        self.U_z_8 = self.inner_init((self.output_dim, self.output_dim))
        self.b_z_8 = shared_zeros((self.output_dim))

        self.W_r_8 = self.init((self.output_dim, self.output_dim))
        self.U_r_8 = self.inner_init((self.output_dim, self.output_dim))
        self.b_r_8 = shared_zeros((self.output_dim))

        self.W_h_8 = self.init((self.output_dim, self.output_dim))
        self.U_h_8 = self.inner_init((self.output_dim, self.output_dim))
        self.b_h_8 = shared_zeros((self.output_dim))

        self.W_z_9 = self.init((self.output_dim, self.output_dim))
        self.U_z_9 = self.inner_init((self.output_dim, self.output_dim))
        self.b_z_9 = shared_zeros((self.output_dim))

        self.W_r_9 = self.init((self.output_dim, self.output_dim))
        self.U_r_9 = self.inner_init((self.output_dim, self.output_dim))
        self.b_r_9 = shared_zeros((self.output_dim))

        self.W_h_9 = self.init((self.output_dim, self.output_dim))
        self.U_h_9 = self.inner_init((self.output_dim, self.output_dim))
        self.b_h_9 = shared_zeros((self.output_dim))
