...
class LSTM(Layer):
    def __init__(self, input_dim, output_dim,
        ...
        self.W_0 = self.init((self.input_dim, self.output_dim))
        self.U_0 = self.inner_init((self.output_dim, self.output_dim))
        self.b_0 = shared_zeros((self.output_dim))

        self.W_1 = self.init((self.output_dim, self.output_dim))
        self.U_1 = self.inner_init((self.output_dim, self.output_dim))
        self.b_1 = shared_zeros((self.output_dim))

        self.W_2 = self.init((self.output_dim, self.output_dim))
        self.U_2 = self.inner_init((self.output_dim, self.output_dim))
        self.b_2 = shared_zeros((self.output_dim))

        self.W_3 = self.init((self.output_dim, self.output_dim))
        self.U_3 = self.inner_init((self.output_dim, self.output_dim))
        self.b_3 = shared_zeros((self.output_dim))

        self.W_4 = self.init((self.output_dim, self.output_dim))
        self.U_4 = self.inner_init((self.output_dim, self.output_dim))
        self.b_4 = shared_zeros((self.output_dim))

        self.W_5 = self.init((self.output_dim, self.output_dim))
        self.U_5 = self.inner_init((self.output_dim, self.output_dim))
        self.b_5 = shared_zeros((self.output_dim))

        self.W_6 = self.init((self.output_dim, self.output_dim))
        self.U_6 = self.inner_init((self.output_dim, self.output_dim))
        self.b_6 = shared_zeros((self.output_dim))

        self.W_7 = self.init((self.output_dim, self.output_dim))
        self.U_7 = self.inner_init((self.output_dim, self.output_dim))
        self.b_7 = shared_zeros((self.output_dim))

        self.W_8 = self.init((self.output_dim, self.output_dim))
        self.U_8 = self.inner_init((self.output_dim, self.output_dim))
        self.b_8 = shared_zeros((self.output_dim))

        self.W_9 = self.init((self.output_dim, self.output_dim))
        self.U_9 = self.inner_init((self.output_dim, self.output_dim))
        self.b_9 = shared_zeros((self.output_dim))
